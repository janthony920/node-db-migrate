...
//ugly hack
var MIGRATION_TABLE_NAME = require('../migration_table_name');
...
module.exports = Base = Class.extend({
  ...
  //forked to have migrations table have any name, and live outside of the database (at least for mysql)
  createMigrationsTable: function(callback) {
    ...
    this.createTable(this.migrationTableName, options, callback);
  },
  ...
  addMigrationRecord: function (name, callback) {
    this.runSql('INSERT INTO ' + this.migrationTableName + ' (name, run_on) VALUES (?, ?)', [new Date()], callback);
  },
